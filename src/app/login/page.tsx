...
import { Mail, Lock, Eye, EyeOff, GraduationCap, AlertCircle, CheckCircle, Loader2 } from "lucide-react"
...
export default function LoginPage() {
  ...
  if (isSuccess) {
    return (
      <div className="min-h-screen bg-gradient-to-b from-blue-50 to-fuchsia-50 dark:from-slate-900 dark:to-slate-800">
        <Navbar />
      ...
      <div className="container mx-auto px-4 py-8 flex items-center justify-center min-h-[calc(100vh-80px)]">
        <div className="w-full max-w-md">
          ...
          <Card className="bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700 shadow-lg">
            <CardHeader>
              <CardTitle className="text-xl text-slate-900 dark:text-slate-100">Вход</CardTitle>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center space-x-2">
                    <Checkbox 
                      ...
                      disabled={isLoading}
                    />
                    <Label htmlFor="rememberMe" className="text-sm cursor-pointer text-slate-700 dark:text-slate-300">
                      Запомнить меня
                    </Label>
                  </div>
                  <Link href="/forgot-password" className="text-sm text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 underline">
                    Забыли пароль?
                  </Link>
                </div>
              </CardContent>
              ...
              <CardFooter className="flex flex-col space-y-4">
                ...
                <p className="text-center text-sm text-slate-600 dark:text-slate-400">
                  Нет аккаунта?{" "}
                  <Link href="/signup" className="text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 underline font-medium">
                    Зарегистрироваться
                  </Link>
                </p>
              </CardFooter>
